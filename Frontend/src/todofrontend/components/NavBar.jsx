  ...
  return (
    <div className="h-full px-16 py-4 shadow-2xl gap-10 items-center justify-evenly hidden md:flex">
      ...
      <div className="flex-1 flex items-center justify-between border border-gray-200 rounded-lg max-w-[500px] shadow-xl ">
        ...
        />
        <div className="w-[35px] h-[35px] cursor-pointer bg-teal-300 rounded-lg p-1">
          <img src={search} alt="search-icon" className="w-full object-cover" />
        </div>
      </div>
      <div className="flex items-center justify-center gap-8">
        ...
        <div className="w-[35px] h-[35px] cursor-pointer bg-teal-300 rounded-lg p-1.5">
